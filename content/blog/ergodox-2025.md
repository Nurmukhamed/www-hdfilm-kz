...
Посмотрите в сторону проектов, которые развились от Ergodox - это [Ergodox EZ][7], [ZSA Moonlander][8]. 
...
Диоды DO-35 на купил в Астане, на принтере распечатал [сгибатель][14]. Приготовил диоды, затем за один выходной день запаял их.
...
~~~json
aic8800d80/bazzite on  main [?] on ☁  (us-east-1)
❯ cat ~/Downloads/ergodox_ez_base_layout_ergodox_pretty_mine.json
{
  "documentation": "\"This file is a QMK Configurator export. You can import this at <https://config.qmk.fm>. It can also be used directly with QMK's source code.\n\nTo setup your QMK e
  "notes": "",
  "version": 1,
  "keyboard": "ergodox_ez/base",
  "keymap": "ergodox_ez_base_layout_ergodox_pretty_mine",
