...
* 2025-11-15 - Я внес серьезные изменения в [репозиторий](https://github.com/Nurmukhamed/OrangePIPC-Boot-From-SPIFLASH) загрузил Docker images в Docker Hub, теперь вы можете просто загрузить готовый Docker image и получить рабочий u-boot образ. Не важно будет это завтра или через 10 лет.
