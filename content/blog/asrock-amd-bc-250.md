...
* [AIC8800D80 Linux Driver](https://github.com/shenmintao/aic8800d80)
* [Telegram Channel for Asrock AMD amd-bc250-docs](https://t.me/BC250public)
...
[FIXED] С первым рекомендуют купить адаптер DisplayPort -> HDMI, может звук появится. **Адаптер UGREEN отлично работает, звук появился.**

[FIXED] Со вторым - ну пишут что в ядре 6.17 данный тип wifi6 был добавлен, но скорее всего в Bazzite он не попал. 

Нашел репозиторий, написал небольшой [rpm spec file](https://github.com/shenmintao/aic8800d80/blob/main/bazzite/aic8800d80.spec), отправил pull request автору репозитория, он одобрил и смержил.
Теперь пользователи Bazzite могут самостоятельно [собрать и установить пакет](https://github.com/shenmintao/aic8800d80/blob/main/bazzite/README.md), после этого появится WIFI, Bluetooth.
