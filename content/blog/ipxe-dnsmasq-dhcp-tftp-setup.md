...
mikrotik не может одновременно определить bios или uefi, сетевая карта может выполнить сетевую загрузку в bios legacy режиме,
а может выполнить в uefi режими, также здесь в uefi могут быть варианты такие как uefi 32 bit, uefi 64 bit, uefi secure boot.
Dnsmasq умеет с таким справляться.
